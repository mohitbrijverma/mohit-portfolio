import type {
  PortfolioPanelId,
} from "@/app/components/portfolio/game/PortfolioWorldHud";
...
export type PortfolioPanelActionIcon =
  | "email"
  | "linkedin"
  | "github"
  | "external";
...
export const portfolioPanels: Record<
  PortfolioPanelId,
...
> = {
  about: {
    ...
    title:
      "Research, teaching and product building meet here.",
    ...
    items: [
      {
        ...
        meta:
          "Nikma Healthcare · Ongoing project",
      ...
      {
        title:
          "Zero-Shot Classification of Psychiatric Diseases",

        meta:
          "IEEE Xplore · Apr 17, 2025",
  ...
  projects: {
    ...
    title:
      "Products and research built around real problems.",
    ...
    items: [
      {
        title:
          "Chemisto · Nikma Healthcare",

        meta:
          "Healthcare product system · Ongoing",
      ...
      {
        title:
          "Medic LLM Assistant for Psychiatric Diseases",

        meta:
          "LTMG Hospital · May 19, 2025",
      ...
      {
        title:
          "Zero-Shot Psychiatric Disease Classification",
      ...
      {
        title:
          "Interplanetary Coronal Mass Ejection Analysis",

        meta:
          "University of Mumbai · Apr–Jun 2024",
    ...
    actions: [
      {
        ...
        href:
          "https://ieeexplore.ieee.org/document/11031589",
  ...
  skills: {
    ...
    title:
      "A multidisciplinary toolkit for building complete systems.",
  ...
  contact: {
    ...
    title:
      "Have an interesting problem to build?",
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Send an email or connect with me through LinkedIn or GitHub. Please include a short description of what you would like to discuss.",
      },
    ],
    ...
    actions: [
      {
        ...
        href:
          "mailto:mohitbrijverma2@gmail.com",
      ...
      },
      {
        ...
        href:
          "https://www.linkedin.com/in/mohit-verma-3839b9226/",
      ...
      },
      {
        ...
        href:
          "https://github.com/mohitbrijverma",
